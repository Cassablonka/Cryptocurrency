...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Cassablonka', amount = 1000)
    block = blockchain.create_block(proof, previous_hash)
    response = {'message' : 'You have mined a block. Congrats !',
                'index': block['index'],
...
def add_transaction():
    ...
    if not all (key in json for key in transaction_keys):
        return 'Some elements of the tranasaction are missing' , 400
